        ...
        mutations.forEach(async function (mutation) {
            ...
            if (mutation.addedNodes[0] !== undefined && mutation.addedNodes[0].className == 'imageTaskContainer') {
                ...
                if (task0 && task1) {
                    ...
                    let diffPrompt = splitStringWithCommas(prompt1, prompt0).join(' ').replace(/ ,/g, ',')
                    ...
                    if (taskConfig !== undefined && task0.diffAdded == undefined && !diffPrompt.includes('[') && !diffPrompt.includes(']')) {
                        // render diff
